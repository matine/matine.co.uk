...
A portfolio site for Matine Chabrier built with [ReactJs](https://reactjs.org/) and [Gatsby](https://www.gatsbyjs.org) with content from [Prismic](https://prismic.io/) and a tiny amount of [Redux](https://redux.js.org).
...
Checks for esLint errors and auto fixes where possible
